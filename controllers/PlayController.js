...
class PlayController {
    index(req, res) {
        ...
        if(req.body.name.match(specialChars) && req.body.room.match(specialChars) && req.body.name.length < 30 && req.body.room.length < 20 && req.body.name.length > 0 && req.body.room.length > 0)
